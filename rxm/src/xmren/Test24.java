...
/**
 * Servlet implementation class Test24
 */
public class Test24 extends HttpServlet {
    ...
    private String createRandomChar(Graphics2D g,String baseChar) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            System.out.println("degree:"+degree+";baseChar.length():"+baseChar.length()+":new Random().nextInt(baseChar.length()):"+new Random().nextInt(baseChar.length()));
